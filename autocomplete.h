...
#define AUTOCOMPLETE_SUCCESS      0
#define AUTOCOMPLETE_BADFILENAME  1
...
//
int AutoComplete_Suggestion(const char *partial_word, const char *prior, const char *completions[], 
			    int size_of_array);
